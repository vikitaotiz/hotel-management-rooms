...
class RoomsController extends Controller
{
    ...
    {
        $this->middleware(['count_room_categories']);
    }
    /**
    ...
    public function booked_rooms()
    {
        ...
        if (request('show_deleted') == 1) {
            ...
            $rooms = Room::where('booked', true)->get();
        }

        return view('admin.rooms.booked_rooms', compact('rooms'));
    }
    ...
    public function available_rooms()
    {
        ...
        if (request('show_deleted') == 1) {
            ...
            $rooms = Room::where('booked', false)->get();
        }

        return view('admin.rooms.available_rooms', compact('rooms'));
    }
    /**
