            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    <select name="account_type" class="form-control">
                        <option value="regular" {{$booking->account_type == 'regular' ? 'selected' : ''}}>Regular</option>
                        <option value="corporate" {{$booking->account_type == 'corporate' ? 'selected' : ''}}>Corporate</option>
                    </select>
                    <p class="help-block"></p>
                ...
                <div class="col-xs-6 form-group">
                    ...
                    <select name="payment_mode" class="form-control">
                        ...
                        <option value="mpesa" {{$booking->payment_mode == 'mpesa' ? 'selected' : ''}}>Mpesa</option>
                        <option value="cheque" {{$booking->payment_mode == 'cheque' ? 'selected' : ''}}>Cheque</option>
                    </select>
                    <p class="help-block"></p>
                    @if($errors->has('account_type'))
                        <p class="help-block">
