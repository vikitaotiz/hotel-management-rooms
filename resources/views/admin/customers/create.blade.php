            ...
            <div class="row">
                <div class="col-xs-6 form-group">
                    ...
                    <select name="document_type" class="form-control">
                        ...
                        <option value="passport_document">Passport Card</option>
                    </select>

                    <p class="help-block"></p>
                    @if($errors->has('id_passport'))
                        <p class="help-block">
                            {{ $errors->first('id_passport') }}
                        </p>
                    @endif
                </div>

                <div class="col-xs-6 form-group">
                    {!! Form::label('id_passport', 'Passport Or ID Number '.'*', ['class' => 'control-label']) !!}
                    {!! Form::text('id_passport', old('id_passport'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('id_passport'))
                        <p class="help-block">
                            {{ $errors->first('id_passport') }}
