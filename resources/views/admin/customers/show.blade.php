            ...
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th>Gender</th>
                            <td field-key='last_name'>{{ $customer->gender }}</td>
                        </tr>
                        <tr>
                            <th>Document Type</th>
                            <td field-key='last_name'>
                                @if ($customer->document_type == 'passport_document')
                                    Passport
                                @else
                                    Identification Card
                                @endif
                        ...
                        <tr>
                            ...
                            <td field-key='last_name'>{{ $customer->id_passport }}</td>
                        </tr>
                        <tr>
