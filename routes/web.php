...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::get('customers_today', 'Admin\CustomersController@today')->name('customers.today');
    ...
    Route::get('booked_rooms', 'Admin\RoomsController@booked_rooms')->name('rooms.booked_rooms');

    Route::get('available_rooms', 'Admin\RoomsController@available_rooms')->name('rooms.available_rooms');
